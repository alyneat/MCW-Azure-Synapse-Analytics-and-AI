...
$sqlScriptsPath = ".\sql"
$workspaceName = "asaworkspace1$($uniqueId)"
$dataLakeAccountName = "asadatalake1$($uniqueId)"
$blobStorageAccountName = "asastore1$($uniqueId)"
$keyVaultName = "asakeyvault1$($uniqueId)"
$keyVaultSQLUserSecretName = "SQL-USER-ASA"
$sqlPoolName = "SQLPool01"
$sqlUserName = "asa.sql.admin"
$integrationRuntimeName = "AzureIntegrationRuntime01"
$sparkPoolName = "SparkPool01"
$amlWorkspaceName = "amlworkspace1$($uniqueId)"
